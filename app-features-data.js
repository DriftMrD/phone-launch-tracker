/**
 * 系统应用功能清单 · 手填情报
 * 一条 = 某系统应用上的一个功能点，挂到搭载该系统的手机上。
 * 发布会 / 系统更新 / 海外反馈 都只是来源，不是两套页面。
 *
 * 改这里，再跑 `node gen-features.js`。不要手改 app-features.html。
 */
module.exports = {

PHONES: [
  { id: 'iphone18',         name: 'iPhone 18',        brand: 'apple',   os: 'iOS 27' },
  { id: 'samsungs26',       name: 'Galaxy S26',       brand: 'samsung', os: 'One UI 9' },
  { id: 'samsungzfold8',    name: 'Z Fold 8',         brand: 'samsung', os: 'One UI 9' },
  { id: 'huaweimatext2',    name: 'Mate XT 2',        brand: 'huawei',  os: 'HarmonyOS 7' },
  { id: 'huaweinova16',     name: 'nova 16',          brand: 'huawei',  os: 'HarmonyOS 7' },
  { id: 'huaweinova16se',   name: 'nova 16 SE',       brand: 'huawei',  os: 'HarmonyOS 7' },
  { id: 'mi17max',          name: '小米 17 Max',      brand: 'xiaomi',  os: 'HyperOS 3/4' },
  { id: 'mi17t',            name: '小米 17T',         brand: 'xiaomi',  os: 'HyperOS 3/4' },
  { id: 'xiaomi18fold',     name: '小米 18 Fold',     brand: 'xiaomi',  os: 'HyperOS 3/4' },
  { id: 'redmik100pro',     name: 'K100 Pro',         brand: 'redmi',   os: 'HyperOS 3/4' },
  { id: 'honor600',         name: '荣耀 600',         brand: 'honor',   os: 'MagicOS 10/11' },
  { id: 'honorx80promax',   name: 'X80 Pro Max',      brand: 'honor',   os: 'MagicOS 10' },
  { id: 'magicvflip3',      name: 'Magic V Flip3',    brand: 'honor',   os: 'MagicOS 10' },
  { id: 'honorrobotphone',  name: 'Robot Phone',      brand: 'honor',   os: 'Agentic OS' },
  { id: 'opporeno16',       name: 'Reno16',           brand: 'oppo',    os: 'ColorOS 16' },
...
BRAND: {
  apple:   { label: '苹果',   color: '#1d1d1f' },
  huawei:  { label: '华为',   color: '#c4161c' },
  xiaomi:  { label: '小米',   color: '#ff6900' },
  redmi:   { label: 'Redmi',  color: '#ff5722' },
  honor:   { label: '荣耀',   color: '#1a6fe8' },
  oppo:    { label: 'OPPO',   color: '#1a9c2d' },
  vivo:    { label: 'vivo',   color: '#415fff' },
  iqoo:    { label: 'iQOO',   color: '#00b8c9' },
  samsung: { label: '三星',   color: '#1428a0' },
  google:  { label: 'Google', color: '#4285f4' }
},

PRODUCTS: [
  { id: 'recorder',  name: '录音机',   color: '#e11d48' },
  { id: 'files',     name: '文件管理', color: '#d97706' },
  { id: 'player',    name: '播放器',   color: '#7c3aed' },
  { id: 'notes',     name: '记事本',   color: '#16a34a' },
  { id: 'calendar',  name: '日历',     color: '#2563eb' },
  { id: 'clock',     name: '时钟',     color: '#0891b2' },
  { id: 'calc',      name: '计算器',   color: '#64748b' },
  { id: 'scan',      name: '扫一扫',   color: '#0d9488' },
  { id: 'theme',     name: '主题商城', color: '#db2777' },
  { id: 'labs',      name: '玩机',     color: '#dc2626' },
...
},
{
  ...
  product: 'recorder',
  brands: ['vivo', 'iqoo'],
  desc: 'OriginOS 7 已官宣：录音机可高亮关键段落和说话人观点，长录音更好回看。当前出厂机仍是 OriginOS 6，该能力属下一代。',
  note: '「高亮关键段」比整篇转写更适合回听。tOS 可先行做时间轴标记 + 观点抽取，不必等整系统 Agent 化。',
  source: { kind: 'update', label: '系统更新 · OriginOS 7（已官宣）', href: 'updates/vivo-originos.html', url: 'https://www.fonearena.com/blog/492411/vivo-originos-7-features-preview-program-registrations-india.html' }
},
{
  name: '端侧录音 → 会议纪要',
  product: 'recorder',
...
},
{
  ...
  product: 'recorder',
  brands: ['samsung'],
  desc: 'Galaxy 录音机说话人 Speaker 1/2/3 社区公认强项，金额能标 "$"；但多口音转写几乎不可用，S24 Ultra 曾卡在 29%，转录文本不能复制，摘要只有 3 条。',
  note: '反面教材：说话人做好了，正文不能复制、摘要过短，办公场景直接废。tOS 底线应是「可复制全文 + 可改说话人 + 口音不过度承诺」。',
  source: { kind: 'update', label: '系统更新 · One UI 8.5', href: 'updates/samsung-voice-recorder.html', url: 'https://www.tomsguide.com/phones/i-tested-the-ai-transcription-tools-for-iphone-vs-samsung-galaxy-vs-google-pixel-heres-the-winner' }
},
{
  name: 'Recorder + Gemini 综合冠军',
  product: 'recorder',
  brands: ['google'],
  desc: 'Tom’s Guide 横向对比：Pixel 录音机在通话/邮件/网页/笔记摘要 6 项里赢 4 项；点 Gemini 即得摘要，比 iPhone「先分享到备忘录」更短。短板是幻影说话人。',
  note: '摘要入口必须在录音机内，不能跳 App。tOS 应对齐 Pixel：录完一键摘要，说话人错误可手改，避免三星那种「分人很准、正文不能用」。',
  source: { kind: 'update', label: '系统更新 · Pixel Recorder', href: 'updates/google-recorder.html', url: 'https://www.tomsguide.com/phones/i-tested-the-ai-transcription-tools-for-iphone-vs-samsung-galaxy-vs-google-pixel-heres-the-winner' }
},
{
  name: '备忘录自然语言建提醒 / 录音进笔记才能摘要',
  product: 'recorder',
  brands: ['apple'],
...
},
{
  ...
  product: 'files',
  brands: ['vivo', 'iqoo'],
  desc: 'OriginOS 7 已官宣（9/16 开发者大会）：AI 文件管家按主题归类相关文件，并可向小 V 问文件内容；输入法在聊天时能推荐本机文档/日程/联系人。现款 X Fold6 / S60 / iQOO 15T / Neo11 出厂仍是 OriginOS 6，该能力随 OriginOS 7 升级，不是已装功能。',
  note: '文件被输入法「带出来」比在文管里翻更快。tOS 可做：聊天/笔记输入时推荐最近相关文档，文管自己负责主题聚类。不要把下一代系统海报写成现款卖点。',
  source: { kind: 'update', label: '媒体转述 · OriginOS 7 官宣', href: 'updates/vivo-originos.html', url: 'https://www.fonearena.com/blog/492411/vivo-originos-7-features-preview-program-registrations-india.html' }
},
{
  name: 'My Files 底栏搜索 + AI 摘要仅旗舰',
  product: 'files',
  brands: ['samsung'],
  desc: 'One UI 8.5 把搜索栏移到底部、加 Storage Share 跨设备看平板/PC 文件。AI 文件摘要却只给 S26：S25 / Z Fold 7 同系统无开关，社区认为分层不公。',
  note: 'UI 重构方向对（单手搜索），但同系统砍 AI 会伤口碑。tOS 文管 AI 摘要应按存储/权限能力分级，不要按销售机型卡死。',
  source: { kind: 'update', label: '系统更新 · One UI 8.5', href: 'updates/samsung-my-files.html', url: 'https://sammyguru.com/exclusive-samsung-my-files-app-one-ui-8-5/' }
},
{
  name: 'Storage Space 2.0 无损压缩腾空间',
  product: 'files',
  brands: ['honor'],
...
/* ========== 播放器 ========== */
{
  name: '锁屏媒体播放器：圆形按钮 + 实时波形',
  product: 'player',
  brands: ['samsung'],
  desc: 'One UI 9 锁屏播放器改为圆形按钮、实时波形，色温跟专辑封面走。被放进稳定版主功能，而不是主题商店插件。',
  note: '播放器差异化在锁屏/岛区，不在本地解码列表。tOS 播放器应把锁屏卡片 + 流体云歌词当成主表面，而不是再做一套独立皮肤页。',
...
/* ========== 记事本 ========== */
{
  name: 'Writing Tools：全系统校对 / 重写 / 四种摘要',
  product: 'notes',
  brands: ['apple'],
...
},
{
  ...
  product: 'notes',
  brands: ['samsung'],
  desc: 'One UI 9：Notes 可用胶带遮敏感信息再分享；Gemini Notebook 能吃 PDF/录音/截图，吐摘要、AI 视频、演示稿、播客、测验。',
  note: '胶带是分享场景的小而美；Notebook 是重入口。tOS 记事本可先做「分享前遮挡」+「录音/PDF 进同一条笔记」，不必一上来生成播客。',
  source: { kind: 'update', label: '系统更新 · One UI 9', href: 'updates/samsung-oneui9-beta.html', url: 'https://gadgets.beebom.com/guides/best-one-ui-9-features' }
},
{
  name: 'AI 闪记 / Mind Space：三指上滑即归档',
  product: 'notes',
  brands: ['oppo'],
...
},
{
  ...
  product: 'notes',
  brands: ['xiaomi', 'redmi'],
  desc: 'HyperOS 3 主打 AI 搜索/笔记/描述；HyperOS 4 继续改笔记应用（官方称 AI 升级，部分机型、部分地区）。和超级小爱圈屏共用理解能力。',
  note: '小米笔记的风险是能力写在系统海报里、App 里感知弱。tOS 每上一个 AI 能力都要在记事本里有明确按钮和失败态，不能只在助手里。',
  source: { kind: 'update', label: '系统更新 · HyperOS 3/4', href: 'updates/xiaomi-hyperos3.html', url: 'https://nokiamob.net/2025/09/24/hyperos-3-global-released-new-ui-ai-tools-and-cross-device-features/' }
},
{
  name: '原子笔记可授权给第三方 AI',
  product: 'notes',
  brands: ['vivo', 'iqoo'],
  desc: 'OriginOS 7：Atomic Notes 可在用户授权下对接第三方 AI。当前 OriginOS 6 已有小 V 记忆 2.0：收藏自动打标签、按主题归档。',
  note: '开放笔记给第三方模型是双刃剑。tOS 可做「导出/授权」开关，默认端侧；主题自动归档值得跟，比再做一个云笔记账号体系更值。',
...
/* ========== 日历 ========== */
{
  name: '截图一键 Add to Calendar',
  product: 'calendar',
  brands: ['apple'],
  desc: '截到活动海报 → 系统按钮一键抽时间/地点生成日程，可预览编辑。9to5Mac 称这是默认日历的差异化；缩略图模式看不到按钮，第三方账号可能冲突。',
  note: '海报/聊天截图建日程是高频刚需。tOS 日历应在截图页和分享菜单都露出「加日程」，不要只藏在全屏截图。',
  source: { kind: 'update', label: '系统更新 · iOS 26', href: 'updates/apple-calendar.html', url: 'https://9to5mac.com/2026/03/05/ios-26-gives-apples-calendar-app-a-convenient-new-advantage/' }
},
{
  name: 'Now Nudge：聊天里建议加日程并开多窗日历',
  product: 'calendar',
  brands: ['samsung'],
  desc: 'One UI 9 在聊天中主动建议添加日历事件，并可打开多窗口 Calendar。S25 曾缺这一项，S26 / Z Fold 8 作为完整 One UI 9 能力出现。',
  note: '日历要能从即时通讯「长出来」。tOS 应做 WhatsApp/Telegram/短信里的日程探测，而不是等用户打开日历 App。',
  source: { kind: 'update', label: '系统更新 · One UI 9', href: 'updates/samsung-oneui9-beta.html', url: 'https://gadgets.beebom.com/guides/best-one-ui-9-features' }
},
{
  name: 'YOYO Schedule：短信/订单/通话自动变待办',
  product: 'calendar',
  brands: ['honor'],
...
},
{
  ...
  product: 'calendar',
  brands: ['vivo', 'iqoo'],
  desc: 'OriginOS 7 官宣 AI Calendar 能按截止日期、时长、偏好和习惯组织任务。属下一代系统，现款出厂 OriginOS 6 未带。',
  note: '从「记时间」变成「排任务」会和待办抢位置。tOS 更稳的是日历管事件、任务管待办，两者可互推，不要合成一个含糊的 AI 盒子。',
  source: { kind: 'update', label: '系统更新 · OriginOS 7（已官宣）', href: 'updates/vivo-originos.html', url: 'https://www.fonearena.com/blog/492411/vivo-originos-7-features-preview-program-registrations-india.html' }
},
{
  name: 'Siri 个人语境读日历',
  product: 'calendar',
  brands: ['apple'],
  desc: 'WWDC / iOS 27：Siri 结合邮件、日历、照片、消息理解意图，可把对话里的安排落到日程；跨 iPhone/iPad/Mac 对话续接。大陆与欧盟暂不上 Siri AI。',
  note: '助手读写日历必须是系统能力。tOS 要把日历做成公共服务：助手、截图、短信都能写，用户在日历里能看到来源和撤销。',
  source: { kind: 'launch', label: '发布会 · WWDC / iPhone 18', href: 'reports/wwdc2026.html', url: 'https://developer.apple.com/wwdc26/' }
},
...
},
{
  ...
  product: 'clock',
  brands: ['xiaomi', 'redmi', 'honor'],
  desc: '小米超级岛、荣耀灵动胶囊把倒计时、取餐、出行状态顶到锁屏/状态栏。它们在抢时钟的「下一事件」位置，而不只是通知。',
  note: '时钟要主动占领岛区：下一个闹钟、倒计时、世界时钟应能进流体云。否则这个表面会被助手和外卖码吃掉。',
  source: { kind: 'update', label: '系统更新 · HyperOS / MagicOS', href: 'updates/xiaomi-hyperos3.html', url: 'https://nokiamob.net/2025/09/24/hyperos-3-global-released-new-ui-ai-tools-and-cross-device-features/' }
},
{
  name: '智能到站提醒：震动 + 弹窗 + 蓝牙播报',
  product: 'clock',
  brands: ['oppo'],
...
/* ========== 计算器 ========== */
{
  name: 'Math Notes：手写即算，iPad 可 3D 作图',
  product: 'calc',
  brands: ['apple'],
...
/* ========== 玩机 ========== */
{
  name: 'Game Booster 内嵌叠加层 + Good Lock',
  product: 'labs',
  brands: ['samsung'],
  desc: 'One UI 9 游戏中可调分辨率和性能模式，不必退出。Good Lock 承担图标/多锁屏等深度玩机；Dual Recording 被挪到 Good Lock 且未充分告知，引发抱怨。',
  note: '玩机工具可以深，但不能把常用相机能力藏进去还不通知。tOS 实验室功能要可发现、可回退，游戏工具条保持前台可及。',
  source: { kind: 'update', label: '系统更新 · One UI 9', href: 'updates/samsung-oneui9-beta.html', url: 'https://gadgets.beebom.com/guides/best-one-ui-9-features' }
},
{
  name: '应用五分身（含串号争议）',
...
},
{
  ...
  product: 'labs',
  brands: ['vivo', 'iqoo'],
  desc: 'OriginOS 7：原子工作台计划下放直板，首帧可打断，五应用任务组可打包流转。现款折叠 X Fold6 已先享四窗口。',
  note: '玩机里最有生产力的是任务组，不是彩蛋。tOS 可做「一组 App 一键恢复」给海外商务机，比再堆动画更值。',
...
/* ========== 换机 ========== */
{
  name: 'Phone Clone：44GB / 57 分钟并省出空间',
  product: 'clone',
  brands: ['honor'],
...
},
{
  ...
  product: 'clone',
  brands: ['samsung'],
  desc: 'One UI 9 Quick Share 加 NFC Tap to Share，并声称与 AirDrop 双向兼容。偏向互传，不是完整换机（Smart Switch 仍是主工具）。',
  note: '互传和换机要分开承诺。tOS 可跟 NFC 碰一碰传文件，但换机向导仍要单独保证 App 数据，不能用互传冒充换机完成。',
  source: { kind: 'update', label: '系统更新 · One UI 9', href: 'updates/samsung-oneui9-beta.html', url: 'https://gadgets.beebom.com/guides/best-one-ui-9-features' }
},

/* ========== 浏览器 ========== */
{
  name: 'Safari AI：标签按主题分组 + Notify Me',
  product: 'browser',
  brands: ['apple'],
...
},
{
  ...
  product: 'browser',
  brands: ['samsung'],
  desc: 'Samsung Internet 的 Ask AI 被列入 S26 相对 S25 的 9 项缺口之一。浏览器 AI 按机型分层，和文管摘要同一套争议。',
  note: '浏览器问 AI 不该是旗舰开关。tOS 可做页内摘要/翻译，走端侧小模型，全机型同一入口，质量可以分级。',
  source: { kind: 'update', label: '系统更新 · One UI 8.5/9', href: 'updates/samsung-my-files.html', url: 'https://techcabal.com/2026/05/15/samsung-one-ui-8-5-problems-and-fixes/' }
},
{
  name: '小布记忆同步系统浏览器与夸克收藏',
  product: 'browser',
  brands: ['oppo'],
...
/* ========== 相册 ========== */
{
  name: '相册 5.0：加载重构 + AI 修图统一入口',
  product: 'gallery',
  brands: ['xiaomi', 'redmi'],
  desc: 'v5.0.7.0 重构缩略图加载，AI 扩图/消除/换天/人像收进统一栏；支持批量参数粘贴、覆盖可恢复、浅色编辑。9 月 4.3.0.20 起首页/影集可自定义布局。',
  note: '相册的产品课是「先不卡，再 AI」。tOS 相册应把修图工具收成一个入口，批量调色可复制，入门机至少共享浏览性能。',
  source: { kind: 'update', label: '系统更新 · 小米相册', href: 'updates/xiaomi-gallery.html', url: 'https://memeosupdates.com/apps/com.miui.gallery/5000700' }
},
{
  name: 'Photos Clean Up / Extend / 空间重构',
  product: 'gallery',
  brands: ['apple'],
...
},
{
  ...
  product: 'assistant',
  brands: ['apple'],
  desc: 'Siri 可在已装第三方 App 里完成操作；对话经 iCloud 在 iPhone/iPad/Mac 间同步。发布会把生态开放和互联放在助手上，而不是开放 API 清单本身。',
  note: 'tOS 要先定三方动作接入协议，优先拉非洲/拉美头部 App。手机+平板共用一套助手上下文，应进云服务基线。',
  source: { kind: 'launch', label: '发布会 · WWDC 2026', href: 'reports/wwdc2026.html', url: 'https://developer.apple.com/wwdc26/' }
},
{
  name: 'Gemini Intelligence：40+ App 链式任务',
  product: 'assistant',
  brands: ['samsung'],
  desc: 'One UI 9 代理式 AI 可查票→比价→订票，接 40+ App；需旗舰芯片 + 12GB + Gemini Nano v3，Z Fold 8 / Ultra 首发。Now Brief 通知摘要口碑尚可。',
  note: '链式任务是助手战争的主战场。tOS 可先做 10 个高频 App 的可靠多步（出行、日历、信息），把成功率做上去再谈 40+。',
  source: { kind: 'update', label: '系统更新 · One UI 9', href: 'updates/samsung-oneui9-beta.html', url: 'https://gadgets.beebom.com/guides/best-one-ui-9-features' }
},
{
  name: '超级小爱 2.0 专家模式：跨应用跨设备执行',
  product: 'assistant',
  brands: ['xiaomi', 'redmi'],
